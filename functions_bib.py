...
from .treinamento.arquiteturas.unetr_2d import config_dict, build_unetr_2d, Patches
print(config_dict)
from .treinamento.arquiteturas.segformer_tf_k2.models import SegFormer_B0
from .treinamento.arquiteturas.segformer_tf_k2.models import SegFormer_B1
from .treinamento.arquiteturas.segformer_tf_k2.models import SegFormer_B2
from .treinamento.arquiteturas.segformer_tf_k2.models import SegFormer_B3
from .treinamento.arquiteturas.segformer_tf_k2.models import SegFormer_B4
from .treinamento.arquiteturas.segformer_tf_k2.models import SegFormer_B5
...
def preprocessa_fine_tuning(input_dir, y_dir):
    # Load Arrays
    x_train = np.load(input_dir + 'x_train.npy')
    x_valid = np.load(input_dir + 'x_valid.npy')
    y_train = np.load(y_dir + 'y_train.npy')
